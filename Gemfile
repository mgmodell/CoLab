...
group :development do
  ...
  # Process manager for Procfile-based development. No patched version available for
  # CVE "Foreman Transpilation Enables OS Command Injection"; restricted to development
  # to prevent installation in production.
  gem "foreman"
end
