...
week_data = YAML.safe_load(File.open('db/narratives/ec_alex.yml'))
...
week_data = YAML.safe_load(File.open('db/narratives/ec_natasha.yml'))
week_data.each do |week|
  Week.create(
    narrative_id: 2,
    week_num: week.week_num,
...
week_data = YAML.safe_load(File.open('db/narratives/ec_anika.yml'))
week_data.each do |week|
  Week.create(
    narrative_id: 3,
    week_num: week.week_num,
...
week_data = YAML.safe_load(File.open('db/narratives/ec_lionel.yml'))
week_data.each do |week|
  Week.create(
    narrative_id: 4,
    week_num: week.week_num,
...
week_data = YAML.safe_load(File.open('db/narratives/gd_anna.yml'))
week_data.each do |week|
  Week.create(
    narrative_id: 5,
    week_num: week.week_num,
...
week_data = YAML.safe_load(File.open('db/narratives/gd_jose.yml'))
week_data.each do |week|
  Week.create(
    narrative_id: 6,
    week_num: week.week_num,
...
week_data = YAML.safe_load(File.open('db/narratives/gd_sam.yml'))
week_data.each do |week|
  Week.create(
    narrative_id: 7,
    week_num: week.week_num,
...
week_data = YAML.safe_load(File.open('db/narratives/gd_kim.yml'))
week_data.each do |week|
  Week.create(
    narrative_id: 8,
    week_num: week.week_num,
...
week_data = YAML.safe_load(File.open('db/narratives/sl_john.yml'))
week_data.each do |week|
  Week.create(
    narrative_id: 9,
    week_num: week.week_num,
...
week_data = YAML.safe_load(File.open('db/narratives/sl_marie.yml'))
week_data.each do |week|
  Week.create(
    narrative_id: 10,
    week_num: week.week_num,
...
week_data = YAML.safe_load(File.open('db/narratives/sl_hannah.yml'))
week_data.each do |week|
  Week.create(
    narrative_id: 11,
    week_num: week.week_num,
...
week_data = YAML.safe_load(File.open('db/narratives/sl_iain.yml'))
week_data.each do |week|
  Week.create(
    narrative_id: 12,
    week_num: week.week_num,
...
cip_data = YAML.safe_load(File.open('db/cip_constants.yml'))
