...
ActiveRecord::Schema.define(version: 20_170_407_024_545) do
  ...
  create_table 'candidates', force: :cascade do |t|
    t.text     'definition',            limit: 65_535
  ...
  add_index 'groups_users', %w(group_id user_id), name: 'index_groups_users_on_group_id_and_user_id', unique: true, using: :btree
  ...
  create_table 'reactions', force: :cascade do |t|
    ...
    t.integer  'user_id',       limit: 4
    t.text     'improvements',  limit: 65_535
    t.datetime 'created_at',                  null: false
    t.datetime 'updated_at',                  null: false
