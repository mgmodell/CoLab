...
ActiveRecord::Schema.define(version: 2021_03_30_044055) do
  ...
  create_table "ahoy_messages", charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.string "token"
    t.text "to"
    t.integer "user_id"
    t.string "user_type"
  ...
  create_table "assessments", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.datetime "end_date"
  ...
  create_table "behaviors", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.string "name_en"
  ...
  create_table "bingo_boards", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
  ...
  create_table "bingo_cells", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
  ...
  create_table "bingo_games", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.string "topic"
    t.text "description"
    t.string "link"
    t.string "source"
  ...
  create_table "candidate_feedbacks", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.string "name_en"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "name_ko"
  ...
  create_table "candidate_lists", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.integer "user_id"
    t.integer "group_id"
    t.boolean "is_group"
    t.datetime "created_at", null: false
  ...
  create_table "candidates", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.text "definition"
  ...
  create_table "cip_codes", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.integer "gov_code"
    t.string "name_en"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "consent_forms", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.string "name"
    t.integer "user_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "consent_logs", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.boolean "accepted"
  ...
  create_table "diagnoses", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
  ...
  create_table "emails", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.integer "user_id"
    t.string "email"
  ...
  create_table "experiences", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.integer "course_id"
    t.string "name"
    t.datetime "start_date"
    t.datetime "end_date"
  ...
  create_table "factor_packs", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.string "name_en"
    t.text "description_en"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "factors", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.text "description_en"
    t.string "name_en"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "genders", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.string "name_en"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.string "name_ko"
  ...
  create_table "group_revisions", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.integer "group_id"
    t.string "name"
    t.string "members"
    t.datetime "created_at", null: false
  ...
  create_table "groups_users", id: false, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.integer "user_id", null: false
    t.integer "group_id", null: false
    t.index ["group_id", "user_id"], name: "index_groups_users_on_group_id_and_user_id", unique: true
  end

  create_table "home_countries", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.string "name"
    t.string "code"
  ...
  create_table "home_states", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
  ...
  create_table "installments", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
  ...
  create_table "narratives", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.string "member_en"
  ...
  create_table "quotes", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.string "text_en"
  ...
  create_table "reactions", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.integer "behavior_id"
  ...
  create_table "rosters", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
  ...
  create_table "scenarios", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.string "name_en"
    t.integer "behavior_id"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "schools", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.text "description"
    t.string "name"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "styles", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.string "name_en"
    t.string "filename"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "themes", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.string "code"
    t.string "name_en"
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
  ...
  create_table "values", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.integer "value"
    t.integer "user_id"
  ...
  create_table "weeks", id: :integer, charset: "utf8", collation: "utf8_unicode_ci", force: :cascade do |t|
    t.integer "narrative_id"
    t.integer "week_num"
    t.text "text_en"
    t.datetime "created_at", null: false
