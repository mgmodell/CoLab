...
ActiveRecord::Schema[7.0].define(version: 20_220_219_194_244) do
  ...
  create_table 'candidate_feedbacks', id: :integer, charset: 'utf8mb3', collation: 'utf8mb3_unicode_ci',
                                      force: :cascade do |t|
    t.string 'name_en'
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
  ...
  create_table 'candidate_lists', id: :integer, charset: 'utf8mb3', collation: 'utf8mb3_unicode_ci',
                                  force: :cascade do |t|
    t.integer 'user_id'
    t.integer 'group_id'
    t.boolean 'is_group'
  ...
  create_table 'consent_forms', id: :integer, charset: 'utf8mb3', collation: 'utf8mb3_unicode_ci',
                                force: :cascade do |t|
    t.string 'name'
    t.integer 'user_id'
    t.datetime 'created_at', precision: nil, null: false
  ...
  create_table 'group_revisions', id: :integer, charset: 'utf8mb3', collation: 'utf8mb3_unicode_ci',
                                  force: :cascade do |t|
    t.integer 'group_id'
    t.string 'name'
    t.string 'members'
  ...
  create_table 'home_countries', id: :integer, charset: 'utf8mb3', collation: 'utf8mb3_unicode_ci',
                                 force: :cascade do |t|
    t.string 'name'
    t.string 'code'
  ...
  create_table 'home_states', id: :integer, charset: 'utf8mb3', collation: 'utf8mb3_unicode_ci', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: nil, null: false
    t.datetime 'updated_at', precision: nil, null: false
    t.index %w[home_country_id name], name: 'index_home_states_on_home_country_id_and_name', unique: true
  ...
  create_table 'weeks', id: :integer, charset: 'utf8mb3', collation: 'utf8mb3_unicode_ci', force: :cascade do |t|
    ...
    t.index %w[week_num narrative_id], name: 'index_weeks_on_week_num_and_narrative_id', unique: true
  end
