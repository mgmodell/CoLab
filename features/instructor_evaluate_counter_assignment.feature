...
# This won't happen until version 2 at least
...
#  Background:
    ...
    #Given the existing "counter" rubric is attached to this assignment
  ...
  #Scenario: Student views current grade and instructor feedback
  #Scenario: Student views assignment submission history
