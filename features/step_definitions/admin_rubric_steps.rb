    ...
    # Then('the user sees {float} rubrics') do |float|
      pending # Write code here that turns the phrase above into concrete actions
    end
    
    Then('the user sets criteria {int} {string} to {string}') do |int, string, string2|
    # Then('the user sets criteria {float} {string} to {string}') do |float, string, string2|
      pending # Write code here that turns the phrase above into concrete actions
    end
    
    Then('the user sets criteria {int} level {int} to {string}') do |int, int2, string|
    # Then('the user sets criteria {int} level {float} to {string}') do |int, float, string|
    # Then('the user sets criteria {float} level {int} to {string}') do |float, int, string|
    # Then('the user sets criteria {float} level {float} to {string}') do |float, float2, string|
      pending # Write code here that turns the phrase above into concrete actions
    end
    
    Then('the user sees the criteria {int} weight is {int}') do |int, int2|
    # Then('the user sees the criteria {int} weight is {float}') do |int, float|
    # Then('the user sees the criteria {float} weight is {int}') do |float, int|
    # Then('the user sees the criteria {float} weight is {float}') do |float, float2|
      pending # Write code here that turns the phrase above into concrete actions
    end
    ...
    # Then('the user will see an empty criteria {float}') do |float|
      pending # Write code here that turns the phrase above into concrete actions
    end
    
    Then('the user sets criteria {int} {string} to to {string}') do |int, string, string2|
    # Then('the user sets criteria {float} {string} to to {string}') do |float, string, string2|
      pending # Write code here that turns the phrase above into concrete actions
    end
    
    Then('the user sets the criteria {int} weight to {int}') do |int, int2|
    # Then('the user sets the criteria {int} weight to {float}') do |int, float|
    # Then('the user sets the criteria {float} weight to {int}') do |float, int|
    # Then('the user sets the criteria {float} weight to {float}') do |float, float2|
      pending # Write code here that turns the phrase above into concrete actions
    end
    ...
    # Then('the rubric criteria {int} level {float} is {string}') do |int, float, string|
    # Then('the rubric criteria {float} level {int} is {string}') do |float, int, string|
    # Then('the rubric criteria {float} level {float} is {string}') do |float, float2, string|
      pending # Write code here that turns the phrase above into concrete actions
    end
