...
Given('the init assignment {string} accept {string}') do |does_or_doesnt, sub_type|
  ...
  Given('the course is shifted {int} {string} into the {string}') do |int, string, string2|
  # Given('the course is shifted {float} {string} into the {string}') do |float, string, string2|
    pending # Write code here that turns the phrase above into concrete actions
  end
  
  Then('the user opens the {string} task') do |string|
    pending # Write code here that turns the phrase above into concrete actions
  end
  
  Then('the user opens the {string} tab') do |string|
    pending # Write code here that turns the phrase above into concrete actions
  end
  ...
  Then('the {string} tab {string} enabled') do |string, string2|
    pending # Write code here that turns the phrase above into concrete actions
  end
  ...
  Then('the user enters a {string} submission') do |string|
    pending # Write code here that turns the phrase above into concrete actions
  end
  
  Then('the assignment has {int} {string} submission') do |int, string|
  # Then('the assignment has {float} {string} submission') do |float, string|
    pending # Write code here that turns the phrase above into concrete actions
  end
  
  Then('the {string} db submission data is accurate') do |string|
    pending # Write code here that turns the phrase above into concrete actions
  end
  ...
  Given('the assignment already has {int} submission from the user') do |int|
  ...
  Then('the user withdraws submission {int}') do |int|
  # Then('the user withdraws submission {float}') do |float|
    pending # Write code here that turns the phrase above into concrete actions
  end
  
  Given('assignment {int} {string} graded') do |int, string|
