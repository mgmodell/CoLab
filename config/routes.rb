...
Rails.application.routes.draw do
  ...
  as :user do
    get 'users/remove_email/:email_id', to: 'registrations#remove_email', as: :remove_registered_email
    get 'users/set_primary_email/:email_id', to: 'registrations#set_primary_email', as: :set_primary_registered_email
