  ...
  return (
    <Fragment>
      ...
      <p>
        ...
        <a href="https://CoLab.online">https://CoLab.online</a>, you are
      ...
      <p>
        ...
        on MMP Technologies, LLC's Website for personal, non-commercial
      ...
      <ul>
        ...
        <li>
          attempt to reverse engineer any software contained on MMP
          Technologies, LLC's Website;
        </li>
        <li>
      ...
      <p>
        This will let MMP Technologies, LLC to terminate upon violations of any
      ...
      <p>
        All the materials on MMP Technologies, LLC’s Website are provided "as
        is". MMP Technologies, LLC makes no warranties, may it be expressed or
        implied, therefore negates all other warranties. Furthermore, MMP
        Technologies, LLC does not make any representations concerning the
      ...
      <p>
        MMP Technologies, LLC or its suppliers will not be hold accountable for
        any damages that will arise with the use or inability to use the
        materials on MMP Technologies, LLC’s Website, even if MMP Technologies,
        LLC or an authorize representative of this Website has been notified,
        orally or written, of the possibility of such damage. Some jurisdiction
      ...
      <p>
        The materials appearing on MMP Technologies, LLC’s Website may include
        technical, typographical, or photographic errors. MMP Technologies, LLC
        will not promise that any of the materials in this Website are accurate,
        complete, or current. MMP Technologies, LLC may change the materials
        contained on its Website at any time without notice. MMP Technologies,
      ...
      <p>
        MMP Technologies, LLC has not reviewed all of the sites linked to its
        Website and is not responsible for the contents of any such linked site.
        The presence of any link does not imply endorsement by MMP Technologies,
        LLC of the site. The use of any linked website is at the user’s own
        risk.
      </p>
      ...
      <p>
        MMP Technologies, LLC may revise these Terms of Use for its Website at
