  ...
  return (
    <Panel header="Privacy Policy for MMP Technologies, LLC">
      ...
      <p>
        ...
        <a href="https://CoLab.online">https://CoLab.online</a>, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by
        CoLab.online and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in CoLab.online. This policy is not applicable to
      ...
      <p>
        CoLab.online follows a standard procedure of using log files. These
      ...
      <p>
        Like any other website, CoLab.online uses 'cookies'. These cookies are
      ...
      <p>
        ...
        advertising partners of CoLab.online.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on CoLab.online, which are sent
      ...
      <p>
        Note that CoLab.online has no access to or control over these cookies
      ...
      <p>
        CoLab.online's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        CoLab.online does not knowingly collect any Personal Identifiable
