...
class ProjectGroups extends React.Component {
  ...
  filter( event ){
    ...
    const filtered = Object.values( students_raw ).
    ...
    return (
      <Paper>
        { this.state.working ?
          ...
          null }
        <Toolbar>
          <InputBase placeholder="Search Students"
            onChange={this.filter} />
          <SearchIcon />
          <Typography color="inherit">
            Showing {this.state.students.length + " of " + this.state.students_raw.length}
          </Typography>
          {this.state.dirty ? (
