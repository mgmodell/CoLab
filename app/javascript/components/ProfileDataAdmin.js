      ...
      fetch(url, {
        ...
        .then(data => {
          ...
          const foundSelectedStates = data.filter( (item ) =>{
            return profileHomeState === item.id || item.code === ( '__:' + countryCode );
          })
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12}>
              <Link href={passwordResetUrl}>
                Want to change your password? Click here and we'll email instructions.
              </Link>
            </Grid>
          </Grid>
        </ExpansionPanelDetails>
      ...
      <ExpansionPanel expanded={'display' === curPanel} onChange={()=>handlePanelClick('display')}>
        ...
        <ExpansionPanelDetails>
          <Grid container spacing={3}>
            <Grid item md={6} xs={12} >
              <FormControl fullWidth>
                ...
                <Select
                  id="profile_theme"
                  value={profileTheme}
                  onChange={event => setProfileTheme(Number(event.target.value))}
                >
                      <MenuItem value={0}>
                        None Selected
                      </MenuItem>
                ...
                <FormHelperText error={true}>{messages['theme']}</FormHelperText>
              </FormControl>

            </Grid>
            <Grid item md={6} xs={12}>
              <FormControl fullWidth>
                <InputLabel htmlFor="profile_language" id="profile_language_lbl">
                  What language would you like to use for CoLab?
                </InputLabel>
                <Select
                  id="profile_language"
                  value={profileLanguage}
                  onChange={event => setProfileLanguage(Number(event.target.value))}
                >
                      <MenuItem value={0}>
                        None Selected
                      </MenuItem>
                ...
                <FormHelperText error={true}>{messages['language']}</FormHelperText>
              </FormControl>

            </Grid>
            <Grid item xs={3} >
            <FormControlLabel
              control={<Switch checked={profileResearcher}
                        onChange={event=>setProfileResearcher(!Boolean(event.target.value))}
                        name="researcher" />}
            ...
            <Grid item xs={9} >
              <FormControl fullWidth>
                <InputLabel htmlFor="profile_timezone" id="profile_timezone_lbl">
                  Time Zone
                </InputLabel>
                <Select
                  id="profile_timezone"
                  value={profileTimezone}
                  onChange={event => setProfileTimezone(String(event.target.value))}
                >
                      <MenuItem value={0}>
                        None Selected
                      </MenuItem>
            ...
            <Grid item xs={12} sm={6}>
              <FormControl fullWidth>
                ...
                <Select
                  id="profile_school"
                  value={profileSchool}
                  onChange={event => setProfileSchool(Number(event.target.value))}
                >
                      <MenuItem value={0}>
                        None Selected
                      </MenuItem>
                ...
                <FormHelperText error={true}>{messages['school_id']}</FormHelperText>
              </FormControl>

            </Grid>
            <Grid item xs={12} sm={6}>
              <FormControl fullWidth>
                <InputLabel htmlFor="profile_cip_code" id="profile_cip_code_lbl">
                  What are you studying?
                </InputLabel>
                <Select
                  id="profile_cip_code"
                  value={profileCipCode}
                  onChange={event => setProfileCipCode(Number(event.target.value))}
                >
                      <MenuItem value={0}>
                        None Selected
                      </MenuItem>
                ...
                <FormHelperText error={true}>{messages['cip_code_id']}</FormHelperText>
              </FormControl>
            ...
            <Grid item xs={12} md={6} >
              ...
              <FormControl fullWidth>
                <Select
                  ...
                  onChange={event => {setProfileHomeState( Number(event.target.value) ) }}
                >
                  {states.map(state => {
                    return (
            ...
            <Grid item xs={12} md={6} >
              <FormControl fullWidth>
                ...
                <Select
                  ...
                  onChange={event => setProfileHomeLanguage(Number(event.target.value))}
                >
                      <MenuItem value={0}>
                        None Selected
                      </MenuItem>
            ...
            <Grid item xs={12} sm={6} >
              <FormControl fullWidth>
                ...
                <Select
                  id="profile_gender"
                  value={profileGender}
                  onChange={event => setProfileGender(Number(event.target.value))}
                >
                      <MenuItem value={0}>
                        None Selected
                      </MenuItem>
            ...
            <Grid item xs={12} md={12}>
              ...
              <ToggleButtonGroup id='impairments' >
                ...
                <ToggleButton
                  ...
                  onClick={()=>{setProfileImpAuditory( !profileImpAuditory )}}
                >
                  Auditory
                </ToggleButton>
                <ToggleButton
                  ...
                  onClick={()=>{setProfileImpCognitive( !profileImpCognitive )}}
                >
                  Cognitive
                </ToggleButton>
                <ToggleButton
                  ...
                  onClick={()=>{setProfileImpMotor( !profileImpMotor )}}
                >
                  Motor
                </ToggleButton>
                <ToggleButton
                  ...
                  onClick={()=>{setProfileImpOther( !profileImpOther )}}
                >
                  Other
                </ToggleButton>
